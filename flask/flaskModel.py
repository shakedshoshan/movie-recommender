...
#     for pred in user_predictions[:20]:  # Display top 20 recommendations
#         print(f"Movie ID: {pred.iid}, Estimated Rating: {pred.est:.2f}")

#     return user_predictions[:20]  # Return top 20 recommendations
...
# # model = load_model("svd_model5.pkl")
# # ratings_df_small = pd.read_csv("rating_ML5.csv")
# reader = Reader(rating_scale=(0.5, 5))
...
#     # Convert the prediction to a serializable format
