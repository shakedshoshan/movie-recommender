    ...
    return(
        <div className="space-y-10 py-10 ">
          <div className="flex flex-row ">
            <h1 className="text-4xl text-white font-bold px-10 pt-2">Model Recommends</h1>
            <button onClick={handleClick} type="submit" className="ml-[50px] text-white text-xl bg-[#3a49d4] rounded-sm hover:bg-[#343d91] border-[#1d213f] space-x-2.5 p-2 ">New reccomends</button>
            </div>
            ...
            {isLoading? <LoadingComp /> :
             <div className="z-20">
                ...
                { reccomends.slice(0, 10).map((movie) => ( 
