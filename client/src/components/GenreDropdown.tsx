...
async function GenreDropdown() {
  ...
  return (
    <DropdownMenu  >
      <DropdownMenuTrigger className="text-[#f0f0f2] items-center flex justify-center hover:border-slate-300 hover:border-b-2 hover:bg-black  hover:bg-opacity-70  rounded py-2 px-2">Genre<ChevronDown /></DropdownMenuTrigger>
